...
def G2K_Analytics():
    ...
    TestName = "G2K_Analytics" # Title of the test
    try:
        ...
        driver.find_element_by_xpath("//body/div[@id='root']/div[1]/div[4]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/div[1]/div[4]/img[1]").click()
...
##Use this code if going to run the test for G2KTesting_Analytics
