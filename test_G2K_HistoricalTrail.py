...
def G2K_HistoricalTrail():

    TestName = "G2K_HistoricalTrail" # Title of the test
    try:
        ...
        driver.find_element_by_xpath("//body/div[@id='root']/div[1]/div[4]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[4]/div[1]/div[4]/img[1]").click()
...
##Use this code if going to run the test for G2KTesting_HistoricalTrail
if __name__ == '__main__':
   ...
   #3. Login to the Historical Trail
   G2K_Login()
